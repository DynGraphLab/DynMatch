...
void init (const std::vector<std::pair<int, std::pair<NodeID, NodeID> > >& sequence, mygraph& g, matemap& m) {
        int mode;
        long u;
        long v;
...
void blossom_match (const Graph& g, MateMap m, VertexIndexMap vim, unsigned long& m_size) {
...
void blossom_matchempty (const std::vector<std::pair<int, std::pair<NodeID, NodeID> > >& sequence, unsigned long& m_size) {
        mygraph g;
        matemap m;
        
        init(sequence, g, m);
        blossom_match<boost::empty_matching>(g, &m[0], boost::get(boost::vertex_index, g), m_size);
}

void blossom_matchgreedy (const std::vector<std::pair<int, std::pair<NodeID, NodeID> > >& sequence, unsigned long& m_size) {
        mygraph g;
        matemap m;
        
        init(sequence, g, m);
        blossom_match<boost::greedy_matching>(g, &m[0], boost::get(boost::vertex_index, g), m_size);
}

void blossom_matchextragreedy (const std::vector<std::pair<int, std::pair<NodeID, NodeID> > >& sequence, unsigned long& m_size) {
        mygraph g;
        matemap m;
        
        init(sequence, g, m);
        blossom_match<boost::extra_greedy_matching>(g, &m[0], boost::get(boost::vertex_index, g), m_size);
}
...
void blossom_untouched (const std::vector<std::pair<int, std::pair<NodeID, NodeID> > >& sequence, unsigned long& m_size, const std::vector<NodeID>& matching) {
        ...
        blossom_match<untouched_matching>(g, &m[0], boost::get(boost::vertex_index, g), m_size);
}
